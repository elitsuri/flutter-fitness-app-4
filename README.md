...
> Flutter Fitness App: Fitness tracker with Flutter, charts, goals, and backend API
...
## 🧰 Tech Stack
Flutter, Dart, Spring Boot, PostgreSQL
...
git clone https://github.com/elitsuri/flutter-fitness-app
